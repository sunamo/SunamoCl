...
#pragma warning enable
    ...
    internal static void KeyAlreadyExists<T, U>(Dictionary<T, U> allActions, T key, string nameOfDict)
    {
        if (allActions.ContainsKey(key)) Custom($"{nameOfDict} already contains key {key}!");
    }
}